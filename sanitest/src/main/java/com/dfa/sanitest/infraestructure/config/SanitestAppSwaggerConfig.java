...
@Configuration
@EnableSwagger2
public class SanitestAppSwaggerConfig {
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfo(SaniTestConsts.FULL_APP_NAME
                            ,SaniTestConsts.DESC_APP_NAME, 
                            SaniTestConsts.VERSION, 
                            SaniTestConsts.LOCALHOST
                            , new Contact("dfa", "", "")
                            ,"LICENSE"
                            ,"LICENSE URL"
